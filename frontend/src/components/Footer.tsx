    ...
    <footer className="border-t border-white/5 pb-12 pt-10">
      <div className="container-shell flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-xl">
          <Logo />
          <p className="mt-4 text-sm leading-7 text-mist/80">Oranum transforma nome, simbolos e data de nascimento em uma experiencia interpretativa desenhada para autoconhecimento, beleza e compartilhamento.</p>
        </div>
        <div className="space-y-3 text-sm text-mist/75 lg:text-right">
          <p>Conteudo interpretativo para autoconhecimento e entretenimento.</p>
